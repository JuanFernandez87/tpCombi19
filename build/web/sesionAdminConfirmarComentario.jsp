...
<body>
    ...
    %>
        ...
        <h3>Quiere publicar su comentario ?</h3><br>
             <a style="display: inline;color: white; background-color: rgb(48, 133, 214);padding: 10px;border-radius: 5px;" href="CrearComentario?idCliente=<%= idC%>&comentario=<%= comentario %>">Aceptar</a>
