	...
	<div class= "contenedor-menu">
		...
		<ul class="menu">
                         <div style="background-color:#494949;color: white;text-align: center">
                            ...
                            <h5>Bienvenido <%=unChofer.getNombre()%> <%=unChofer.getApellido()%></h5>
                            <h5><%=tipoUsuario%></h5> 
                   </div>
				...
				<ul>
					<li><a href="listadoViajesChofer.jsp">Pendientes</a></li>
                                        <li><a href="listadoViajesChoferIniciado.jsp">Iniciados</a></li>
                                        <li><a href="listadoViajesChoferFinalizado.jsp">Finalizado</a></li>
				</ul>

			</li>
                        
                        <!-- boton con menu para Combi.-->
                             <li ><a href="#"><i class="icono izquierda fas fa-book" ></i>Administrar pasajeros<i class="icono derecha fas fa-chevron-down"></i></a>
				<ul>
                                        <li><a href="#">Listar</a></li><!--Con este codigo se redirige al registro de Combi-->
