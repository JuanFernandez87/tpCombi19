...
<body>
    ...
    %>
        ...
        <div class="formulario-sesiones">
            <form>
	    <div class="divCierre">
                <h3>Quiere eliminar a la combi con patente:  <%=patente%> ?</h3>
                <a style="display: inline;color: white; background-color: rgb(48, 133, 214);padding: 5px;" href="EliminarCombi?idCombi=<%= id %>"">Aceptar</a>
