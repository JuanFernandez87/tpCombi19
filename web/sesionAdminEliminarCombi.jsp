...
<body>
    <%
        String patente="";
        int id=0;
        patente = request.getParameter("Combi");
	...
	<div style=" position: absolute;background: #fff;top:50%;left: 50%;margin-top: -100px;margin-left: -100px;padding:20px;font-family: inherit;font-size: 1rem;
        color: #595959;text-align: center;padding: 70px; border: none;border-radius: 5px;">		
                ...
                <h3>Quiere eliminar a la combi con patente:  <%=patente%> ?</h3><br>
                <a style="display: inline;color: white; background-color: rgb(48, 133, 214);padding: 10px;border-radius: 5px;" href="EliminarCombi?idCombi=<%= id %>"">Aceptar</a>
