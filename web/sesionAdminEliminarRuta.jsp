...
<body>
    ...
    %>
        ...
        <div class="formulario-sesiones">
            <form>
	    <div class="divCierre">
                <h3>Quiere eliminar ruta con destino <%=destino %>?</h3>
                <a style="display: inline;color: white; background-color: rgb(48, 133, 214);padding: 5px;" href="EliminarRuta?idRuta=<%= id %>"">Aceptar</a>
