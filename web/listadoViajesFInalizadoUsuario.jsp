      ...
      <%
            ...
            for (Pasaje unPasaje:listaPasajes){
                     ...
                     if(unPasaje.getIdCliente() == idCliente){
                        if(unPasaje.getEstado().equals("Finalizado")){  //Finalizado
                            cant++;
                        }
                     }
            }
        ...
        <div class="cajaListado">
            <h1>Listado de viajes Finalizados</h1>
        <table>
            <tr>
                <td>Origen</td> 
                <td>Destino</td> 
                ...
                <%for (Pasaje unPasaje:listaPasajes){
                     ...
                     if((unPasaje.getIdCliente() == idCliente)&&(unPasaje.getEstado().equals("Finalizado"))){%>
                ...
                <tr>
                    ...
                    <%}}}}}}}
                     ...
                     <script src="js/sweetAlertNohayPasajesFinalizados.js"></script>  
